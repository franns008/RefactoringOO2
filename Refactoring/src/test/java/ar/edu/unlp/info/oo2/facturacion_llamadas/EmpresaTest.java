...
class EmpresaTest {
	...
	void testcalcularMontoTotalLlamadas() {
		...
		assertEquals(11454.64, this.sistema.calcularMontoLlamadasCliente(emisorPersonaFisca), 0.01);
		assertEquals(2445.40, this.sistema.calcularMontoLlamadasCliente(emisorPersonaJuridica), 0.01);
		assertEquals(0, this.sistema.calcularMontoLlamadasCliente(remitentePersonaFisica));
		assertEquals(0, this.sistema.calcularMontoLlamadasCliente(remitentePersonaJuridica));
	}
